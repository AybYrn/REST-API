...
//                            items = items.splice(items.findIndex(i => i.product_id === id), 1);
        ...
        <div class="container">
            <h5 class="mt-5">
                <a href="home.html" class="text-body text-decoration-none text-center">
                    <svg class=" mb-1 ms-2" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-md-4">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="btn btn-outline-dark btn-warning btn-lg btn-block">
                                Go to checkout
                            </button>
                        </div>
                    </div>
