...
$app->get('/market/:id',  'getMarketById'); //get markets by id
$app->get('/market/searchMarketName/:name', 'getMarketByName'); //search market by name

$app->get('/products/:page', 'getProducts'); //get all products
$app->get('/productsCount', 'getProductCount'); //get all products
$app->get('/product/:id', 'getProductById'); // get product by id
$app->get('/product/searchProductName/:name', 'getProductByName'); //get product by name
$app->get('/product/searchProductNamefromMarket/:id/:name', 'getProductByNamefromMarket'); //get product by name based on market
$app->get('/product/productByMarket/:id', 'getProductByMarketId'); //get products belong to the market by market id
$app->get('/product/pic/:id', 'getProductPic'); //get product pictures
